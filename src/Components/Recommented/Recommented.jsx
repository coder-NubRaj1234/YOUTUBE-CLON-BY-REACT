...
const Recommented = ({ categoryId }) => {
  const { deviseMobile, scrollZero, setScrollZero } = useContext(Context);
  ...
  return (
    <div
      ...
      className="recommented md:basis-[33%] hide-scrollbar  md:h-[100%]  md:overflow-y-scroll w-[100vw] flex flex-col gap-4 pb-2 "
    >
      {apiData &&
